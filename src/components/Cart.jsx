            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col text-center">
                        <div className="alert alert-danger" role="alert"><h2 className='text-center text-dark fs-6'>No se encontraron productos en el Carrito</h2><Link to="/" className='btn btn-dark rounded-0 btn-buyNow background-secondary mt-2'>Ver productos</Link></div>
                    </div>
                </div>
            </div>
        )
